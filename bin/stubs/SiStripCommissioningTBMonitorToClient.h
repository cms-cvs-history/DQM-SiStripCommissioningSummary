#ifndef DQM_SiStripCommissioningSummary_SiStripCommissioningTBMonitorToClient_h
#define DQM_SiStripCommissioningSummary_SiStripCommissioningTBMonitorToClient_h
...
/** 
    @file : DQM/SiStripCommissioningSummary/bin/stubs/SiStripCommissioningTBMonitorToClient.h
    @class : SiStripCommissioningTBMonitorToClient
    @author : M.Wingham
...
class SiStripCommissioningTBMonitorToClient {
 ...
 public:
  ...
  /** Constructor */
  explicit SiStripCommissioningTBMonitorToClient(std::string& client_path, std::string& tb_path, sistrip::Task = sistrip::PEDESTALS);

  /** Destructor */
  ~SiStripCommissioningTBMonitorToClient();
...
#endif // DQM_SiStripCommissioningSummary_SiStripCommissioningTBMonitorToClient_h
