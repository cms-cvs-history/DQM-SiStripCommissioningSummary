#ifndef DQM_SiStripCommissioningSummary_ConvertTBMonitorHistos_h
#define DQM_SiStripCommissioningSummary_ConvertTBMonitorHistos_h
...
/** 
    @file : DQM/SiStripCommissioningSummary/bin/stubs/ConvertTBMonitorHistos.h
    @class : ConvertTBMonitorHistos
    @author : M.Wingham
...
class ConvertTBMonitorHistos {
 ...
 public:
  ...
  /** Constructor */
  explicit ConvertTBMonitorHistos(std::string& client_path, std::string& tb_path, sistrip::Task = sistrip::PEDESTALS);

  /** Destructor */
  ~ConvertTBMonitorHistos();
...
#endif // DQM_SiStripCommissioningSummary_ConvertTBMonitorHistos_h
